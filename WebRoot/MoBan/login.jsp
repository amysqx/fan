...
<div class="bottom">
    <div class="fenlei">
        <div class="font1 bg01">
            个人发布</div>
        免费发布求购、求租、出售、出租及委托房源信息</div>
    <div class="fenlei">
        <div class="font1 bg02">
            专业评估</div>
        基于海量信息，即时、快捷地提供房屋最新估价信息</div>
...
<div style="width:960px;height:105px;background:#fff;font-size:12px;font-family:'宋体';clear:both;margin:0 auto;border-top:1px solid #ccc;" class="DivCss20091020WZiColor333">
	...
	<div style="line-height:23px;text-align:center;position:relative;"> its AMY Shen 科技发展有限公司 版权所有</div>
	<div style="line-height:20px;text-align:center;">举报电话：<span style="font-family:Verdana;">999-999-9999</span> 举报邮箱：<a href="mailto:jubao@fang.com" style="font-family:Verdana;">jubao@999.com</a></div>
</div>
