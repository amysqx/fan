            ...
            <div class="leftList">
                <ul class="formList">
                    <li id="usernameregion" style="position: relative; z-index: 2;">
                        <label><em class="red">*</em> USERNAME：</label><input type="text" id="user.userName" name="user.userName" class="inputStyle" />
                    ...
                    <li style="position: relative;">
                        <label><em class="red">*</em> PASSWORD：</label><input type="password" class="inputStyle" id="user.pwd" name="user.pwd" />
                        <div class="" id="div_strPassword" style="position: absolute; top: 0; left: 62%;"></div>
                    </li>
                    <li id="usernameregion" style="position: relative; z-index: 2;">
                        <label><em class="red">*</em> NAME：</label><input type="text" id="user.realName" name="user.realName" class="inputStyle" />
                        <div class="dropdown" id="userDiv" style="display: none;"></div>
                        <div class="" id="div_strUsername" style="position: absolute; top: 0; left: 62%;"></div>
                    </li>

                    <li style="position: relative;">
                        <label><em class="red">*</em> TEL NUM：</label>
                    ...
                    <li>
                        <label></label>
                        <input type="submit" value="GO!" class="btnStyle" id="img_submit" />
                    </li>
                </ul>
            </div>
			</form>
    ...
    <div class="sfunfooter20120411">
       ...
       <a href="http://www.fang.com/aboutus/contactus.html" target="_blank">联系我们</a>‖
        ...
        <a href="http://www.fang.com/service/feedback/LeaveMess.aspx/" target="_blank">意见反馈</a>‖
         <a href="http://client.3g.fang.com/http/wap/index.html" target="_blank">LWM app</a>‖
      ...
      <a href="http://www.fang.com/zt/201107/xbc.html" target="_blank">加盟搜房网</a>
        ...
        <div class="verdana">
            ...
            AMY Shen Limited, All Rights Reserved
        </div>
        <div class="song" style="line-height: 23px; position: relative; z-index: 1">its AMY Shen 科技发展有限公司 版权所有<a target="_blank" href="http://www.hd315.gov.cn/beian/view.asp?bianhao=0102000110800002"><img style="border:0pt none;position:absolute;right:249px;top:-18px;" src="https://static.soufunimg.com/passport/pcimages/beian_min.gif"/>
        </a></div>
        <div class="song">客服电话：<em>0000000000</em> 违法信息举报邮箱：<a href="mailto:jubao@soufun.com"><em>jubao@999.com</em></a></div>
