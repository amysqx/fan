...
<head>
    <title>
        【厦门租房网_厦门租房信息|房屋出租】- 搜房网
    </title>
    <meta name="keywords" content="厦门租房，厦门租房网，厦门租房，租房信息" />
    <meta name="description" content="搜房网厦门租房网提供厦门海量出租房源，实时更新，审核，租房信息真实有效。厦门租房子、找合租、个人房屋出租，就到搜房网。" />
    ...
    <script type="text/javascript" language="javascript">
        ...
        var cityname = '厦门'; var jxurl = ''; var city = '厦门';
        var isrealhouseurl = '';
...
<body>
    <div class="nav613">
        <div class="nav613nr">
		    	<div class="s1">
		       	  <a href="http://client.3g.fang.com/http/wap/index.html" class="mob" target="_blank" rel="nofollow">LWM APP</a><a href="http://agent.fang.com" class=""  style="float:none;display:inline" target="_blank" rel="nofollow">经纪人登录</a>
		        </div>
		   	  <div class="s2"><span id="loginBar" ></span> | <a href="http://my.fang.com/?city=xiangyang" target="_blank" rel="nofollow">My LWM</a> | <a href="http://help.fang.com/" target="_blank" rel="nofollow">Help</a> | <a href="http://fang.com/sitemap/sitemap.html" id="dsy_B01_04" target="_blank" rel="nofollow" >网站地图</a></div>
		    	<div class="clear"></div>
		    </div>
    </div>
    <div class="wrap">
...
<div class="soufunsearch110615" style="margin-top: 40px; margin-bottom: 40px;">
    <div class="soufunsearch110615logo" id="dsy_B01_29">
		...
		<strong>泉州市</strong> <span class="zilink">[<a href="<%=path %>/index.jsp"  rel="nofollow">切换</a>]</span>		
		</div>
    </div>
</div>
...
<script type="text/javascript">initLoginWindowDetail();</script>
    ...
    <div class="wid1000">
        ...
        <div class="guide" id="rentid_83">
            <a href="http://www.fang.com/" target="_blank" rel="nofollow" >LWM</a> &gt; <a href="http://zu.xiangyang.fang.com/" target="_blank" >泉州租房</a>
        </div>
        <!--guide end-->
        <!-- searchlink start -->
       ...
       <div class="quxian mt15 ml25" id="rentid_47">
                    ...
                    <p class="qxName">
        <input type="radio" value="武昌区" class="org bold" name="house.area"/>学校附近
        <input type="radio" value="洪山区" class="org bold" name="house.area"/>商圈附近
...
.dvSel ul.tag_options li.open_selected{ background:#E6F1FA;}
        ...
        <div class="listBox mt10 floatl">
            <!--menu star-->
            <ul class="menu black">
                <li class="liOn" id="rentid_B03_10" ><a href="<%=path%>/MoBan/index.jsp/" rel='nofollow'>全部房源</a></li><li  id="rentid_B03_11"><a href="<%=path%>/MoBan/index.jsp/a23/" rel="nofollow">LWM精选</a></li><li  id="rentid_58"><a href="<%=path%>/MoBan/index.jsp/a21/" rel='nofollow'>个人房源</a></li>
    ...
    function AddFavorite() {
        ...
        <div id="http://esfbj_71" style="width: 1000px; height: 105px; background: #fff;
                ...
                <span style="font-family: Verdana;">‖</span> <a href="http://www.fang.com/sitemap/sitemap.html"
                    target="_blank">网站地图</a> <span style="font-family: Verdana;">‖</span> <a href="http://www.fang.com/service/feedback/LeaveMess.aspx/"
                        target="_blank">意见反馈</a> <span style="font-family: Verdana;">‖</span> <a href="http://wap.fang.com/xc/mobile.html"
                            target="_blank">LWM app</a>‖  <span style="font-family: Verdana;">
            ...
            <div style="font-family: Verdana; line-height: 20px; text-align: center;">
                ...
                AMY Shen Limited, All Rights Reserved</div>
            <div style="line-height: 23px; text-align: center; position: relative;"> 
               its AMY Shen科技发展有限公司 版权所有</div>
            <div style="line-height: 20px; text-align: center;">
                举报电话：<span style="font-family: Verdana;">999-999-9999</span> 举报邮箱：<a href="mailto:jubao@fang.com"
                    style="font-family: Verdana;">jubao@999.com</a></div>
        </div>
