		...
		<div class="nav613nr">
			<div class="s1">
				<a href="<%=path%>/admin/login.jsp"
					style="float:none;display:inline" rel="nofollow">管理员登录</a> <a
					href="<%=path%>/MoBan/login.jsp" rel="nofollow">用户登录</a> <a
					href="<%=path%>/MoBan/reg.jsp" rel="nofollow">用户注册</a>
			</div>
			<div class="s2">
				<span id="loginBar"></span> | <a
					href="<%=path%>/house!myhouse.action" rel="nofollow">My LWM</a> | <a
					href="<%=path%>/ding!myding.action" rel="nofollow">My Order</a> | <a
		...
		<div class="soufunsearch110615"
			...
			<div class="soufunsearch110615logo" id="dsy_B01_29">
				...
				<div class="soufunsearch110615city">
					<strong>厦门市</strong> <span class="zilink">[<a
	...
	<div class="wid1000">
		...
		<div class="search mt10">
			...
			<form action="<%=path%>/house!select.action" method="post">
				<div>
					<ul class="info ml25">
						<li id="Li1">区域： <input type="radio" value="集美区"
							class="org bold" name="house.area" />集美区 <input type="radio"
							value="思明区" class="org bold" name="house.area" />思明区 <input
							type="radio" value="湖里区" class="org bold" name="house.area" />湖里区
				...
				<ul class="info ml25">
					...
					<li id="rentid_B02_07">租住类型： <input type="radio" value="整租"
						class="org bold" name="house.rentType" />单人间 <input type="radio"
						value="合租单间" class="org bold" name="house.rentType" />双人间 <input
						type="radio" value="合租床位" class="org bold" name="house.rentType" />四人间
					</li>
				</ul>
				<br>
	...
	color: #f00;
            ...
            font-size: 12px; font-family: '宋体'; clear: both; margin: 0 auto; border-top: 1px solid #ccc;"
				...
				<div style="line-height: 20px; text-align: center;">
					举报电话：<span style="font-family: Verdana;">999-999-9999</span> 举报邮箱：<a
						href="mailto:jubao@fang.com" style="font-family: Verdana;">jubao@999.com</a>
				</div>
			</div>
