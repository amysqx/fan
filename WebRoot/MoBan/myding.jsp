        ...
        <div class="houseList" id="rentid_66">
            <c:forEach var="data"  items="${dingList }" >
                    <dl class="list hiddenMap rel" id='rentid_B04_01'>
                        <dt class="img rel floatl"><a href="<%=path %>/house!detail.action?house.id=${data.houseInfo.id}" target="_blank" title="${data.houseInfo.rentType }出租,${data.houseInfo.fixture },${data.houseInfo.room }室${data.houseInfo.lroom }厅,${data.houseInfo.sqm }㎡,${data.houseInfo.price }元/月">
                            <img height="135" width="180" usertype="1" src2="http://img8.soufunimg.com/viewimage/agents/2015_01/09/M07/03/19/wKgEQlSvktiICHQnAATfitGA2pEAAE2BwLz2DkABN-i879/180x135.jpg"
                                src="<%=path%>/Images/${data.houseInfo.img }" onerror="imgiserror(this,'http://img8.soufunimg.com/agents/2015_01/09/M07/03/19/wKgEQlSvktiICHQnAATfitGA2pEAAE2BwLz2DkABN-i879.jpg')" /></a>
                        </dt>
                        <dd class="info rel floatr">
                            <p class="title">
                                <a href="<%=path %>/house!detail.action?house.id=${data.houseInfo.id}">
                                   ${data.houseInfo.title }
                                </a>         
                            </p>
                            
                            <p class="gray6 mt10">
                                <a href='<%=path%>/MoBan/index.jsp-a013214/' >${data.houseInfo.area }</a>-
                                <a href='<%=path%>/MoBan/index.jsp-a013214-b015471/' >${data.houseInfo.circle }</a>-
                                <a href="<%=path%>/MoBan/index.jsp/kw%b6%fe%ca%ae%d6%d0%d1%a7%d0%a3%c5%d4%b2%bf%b6%d3%bc%d2%ca%f4%d4%ba/" target="_blank"><span>${data.houseInfo.homeName }</span></a>
                                <span class="iconAdress ml10" title='${data.houseInfo.homeName }'>
                                   ${data.houseInfo.homeName }
                                </span>
                            </p>
                            <p class="gray6 mt5">
                                ${data.houseInfo.room }室${data.houseInfo.lroom }厅<span class="gray9 mlr5">/</span>${data.houseInfo.sqm }㎡(建筑面积)<span class="gray9 mlr5">/</span>${data.houseInfo.fixture }<span class="gray9 mlr5">/</span>${data.houseInfo.floor }/${data.houseInfo.sfloor }层<span class="gray9 mlr5">/</span>朝${data.houseInfo.direction }
                            </p>
    ...
    function AddFavorite() {
        ...
        <div id="http://esfbj_71" style="width: 1000px; height: 105px; background: #fff;
            ...
            <div style="line-height: 23px; text-align: center; position: relative;">
               its AMY Shen 科技发展有限公司 版权所有</div>
